    ...
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20 font-['Founders_Grotesk']">
      <div className='w-1/2 h-full flex flex-col justify-between'>
        <div className="heading">
          <h1 className="text-[6.3vw] font-semibold uppercase leading-none -mb-10">
            Eye-
          </h1>
          <h1 className="text-[6.3vw] font-semibold uppercase leading-none -mb-10">
            Opening
      ...
      <h1 className="text-[6.3vw] font-semibold uppercase leading-none -mb-10">
          ...
          <div className="dets font-['Neue_Montreal'] mt-10">
                <a className="block text-xl font-light hover:underline" href="#">Facebook</a>
                <a className="block text-xl font-light hover:underline" href="#">Linkedin</a>
                <a className="block text-xl font-light hover:underline" href="#">Instagram</a>
                <a className="block text-xl font-light hover:underline" href="#">Twitter</a>
            </div>
      </div>
    </div>
  );
